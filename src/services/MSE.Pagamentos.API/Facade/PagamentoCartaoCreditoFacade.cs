...
using MSE.Pagamentos.MedisPag;

namespace MSE.Pagamentos.CardAntiCorruption
{
    public class PagamentoCartaoCreditoFacade : IPagamentoFacade
    {
        ...
        {
            var nerdsPagSvc = new MedisPagService(_pagamentoConfig.DefaultApiKey,
        ...
        public static Transaction ParaTransaction(Transacao transacao, MedisPagService MedisPagService)
        {
            return new Transaction(MedisPagService)
            {
