...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSE.Pedidos.Domain.Pedidos.Pedido", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MSE.Pedidos.Domain.Pedidos.PedidoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MSE.Pedidos.Domain.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MSE.Pedidos.Domain.Pedidos.Pedido", b =>
                {
                    b.HasOne("MSE.Pedidos.Domain.Voucher", "Voucher")
                        .WithMany()
                        .HasForeignKey("VoucherId");

                    b.OwnsOne("MSE.Pedidos.Domain.Pedidos.Endereco", "Endereco", b1 =>
                        {
            ...
            modelBuilder.Entity("MSE.Pedidos.Domain.Pedidos.PedidoItem", b =>
                {
                    b.HasOne("MSE.Pedidos.Domain.Pedidos.Pedido", "Pedido")
